...
import { processSecureOrder, sendOrderToDiscord } from "app/actions/checkout";
...
export function CheckoutForm({
  ...
  const [txCode, setTxCode] = useState("SNT-...");
  ...
  useEffect(() => {
    setTxCode(`SNT-${Math.floor(100000 + Math.random() * 900000)}`);
  }, []);
  ...
  async function finalizeOrder() {
    ...
    try {
      ...
      const result = await processSecureOrder({
        txCode,
        form,
        lines,
        total,
