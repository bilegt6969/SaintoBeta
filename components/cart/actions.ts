...
export async function addItem(
  ...
  if (!cartId) {
    try {
      ...
      cartId = cart.id;
      cookieStore.set("cartId", cartId!, secureCookieOptions());
    } catch (e) {
...
export async function wipeCartCookie() {
  try {
    ...
    if (freshCart && freshCart.id) {
      ...
      cookieStore.set("cartId", freshCart.id, secureCookieOptions());
    }
...
export async function createCartAndSetCookie() {
  ...
  (await cookies()).set("cartId", cart.id!, secureCookieOptions());
}
