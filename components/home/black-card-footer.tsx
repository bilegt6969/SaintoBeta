...
export function BlackCardFooter() {
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || process.env.SITE_NAME || "Sainto";
  ...
  return (
    <div className="mt-3 space-y-2">
      ...
      <p className="text-xs leading-relaxed text-neutral-500">Sainto by bytecode</p>
